...
export class Backend implements backendInterface {
    ...
    async addImageRequest(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addImageRequest(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async consumeTokens(arg0: bigint, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.consumeTokens(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getImageHistory(): Promise<Array<ImageRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getImageHistory();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTopScores(arg0: string): Promise<Array<GameScore>> {
        if (this.processError) {
            try {
    ...
    async resetMonthlyTokens(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.resetMonthlyTokens();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
